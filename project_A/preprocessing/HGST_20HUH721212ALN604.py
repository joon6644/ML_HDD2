...
def main():
    parser = argparse.ArgumentParser(description="HGST_20HUH721212ALN604 디스크 시계열 데이터 전처리 파이프라인")
    parser.add_argument(
        "--max-memory",
        type=str,
        default="16GB",
    ...
    print("=" * 80)
    print(f" HGST_20HUH721212ALN604 전용 전처리 시작")
    ...
    try:
        ...
        print("=" * 80)
        print(f" HGST 전처리 완료! 총 소요시간: {time.time() - t_start:.2f}초")
        print("=" * 80)
